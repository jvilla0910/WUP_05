...
The drug appears to make women more susceptible to the virus.
...
fisher.test(table1)
```
We reject the null hypothesis because the p-value is less then 0.05. Our p-value is 0.0007686. The fisher exact table is also a significant in showing that we reject the null hypothesis because our p value is 0.00006596. 
